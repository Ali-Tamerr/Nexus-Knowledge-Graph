...
function MaterialItem({ item, type, onSelect }: MaterialItemProps) {
  const getIcon = () => {
    if (type === 'assignment') {
  ...
  return (
    <div
      onClick={onSelect}
      className="border border-zinc-700 rounded-lg p-4 cursor-pointer transition-colors hover:bg-zinc-800 hover:border-zinc-600"
    >
      ...
      <div className="flex flex-col h-[600px]">
        ...
        <div className="flex-shrink-0 p-4 border-b border-zinc-800">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h2 className="text-lg font-semibold text-white">Section Material</h2>
          ...
          {isLoading ? (
            ...
            <div className="flex items-center justify-center h-full">
              <div className="text-center">
                <p className="text-red-400 mb-2">Failed to load course materials.</p>
